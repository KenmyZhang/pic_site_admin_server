...
import (
	...
	"github.com/KenmyZhang/pic_site_admin_server/app/params"
	cartVo "github.com/KenmyZhang/pic_site_admin_server/app/service/cart_service/vo"
	"github.com/KenmyZhang/pic_site_admin_server/app/service/pic_service"
	productVo "github.com/KenmyZhang/pic_site_admin_server/app/service/pic_service/vo"
	cartEnum "github.com/KenmyZhang/pic_site_admin_server/pkg/enums/cart"
	orderEnum "github.com/KenmyZhang/pic_site_admin_server/pkg/enums/order"
...
func (d *Cart) GetCartList() map[string]interface{} {
	...
	maps["uid"] = d.Uid
	maps["is_pay"] = orderEnum.PayStatusUnpay
	if d.Status == 0 {
...
func (d *Cart) AddCart() (int64, error) {
	...
	whereCart := &models.YshopStoreCart{
		Uid:               d.Uid,
		IsPay:             orderEnum.PayStatusUnpay,
...
func CheckStock(productId int64, cartNum int, unique string) error {
	...
	productService := pic_service.Product{
		Id:     productId,
		Unique: unique,
	}
