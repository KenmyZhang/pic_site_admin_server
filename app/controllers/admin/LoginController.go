...
import (
	...
	"github.com/KenmyZhang/pic_site_admin_server/app/models/dto"
	"github.com/KenmyZhang/pic_site_admin_server/app/models/vo"
	"github.com/KenmyZhang/pic_site_admin_server/app/service/user_service"
...
func (e *LoginController) Login(c *gin.Context) {
	...
	httpCode, errCode, errMsg := app.BindAndValid(c, &authUser)
